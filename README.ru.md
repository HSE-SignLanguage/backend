...
- первое принятое ML-предсказание публикуется сразу;
...
- Правка OpenRouter не способна исправить неверно распознанный жест; при пустой delta используется принятый буквальный жест.
